    ...
    if x == 2:
        ...
        if lojas != []:
            for i in range(len(lojas)):
                print(i," - ",lojas[i])
            print((len(lojas))," - Sair")
            n = int(input('Escolha a loja: '))
            if 0 <= n < len(lojas):
                del controle_loja[lojas[n]]
                del lojas[n]
                print('Até mais!')
                alberto = False
                alberto2 = False
        ...
        #alterar item
            ...
            if k == 0:
                ...
                while e not in controle_estoque:
                    ...
                    print("Nova quantidade: ",controle_estoque[e]["quantidade"])
            elif k == 1:
                e = str(input("Nome do produto: "))
                while e not in controle_estoque:
                    print("Elemento não encontrado")
